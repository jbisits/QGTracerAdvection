#Set up a flow with parameters that have mid-latitude values on a domain of 1000km * 1000km, resolution 128
...
stepper = "FilteredRK4"     # timestepper
     dt = 3600/2            # timestep (some fraction of one day in seconds)
