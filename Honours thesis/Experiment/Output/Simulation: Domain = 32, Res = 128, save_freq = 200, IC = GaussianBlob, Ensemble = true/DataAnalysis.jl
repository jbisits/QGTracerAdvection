...
cd(joinpath(SimPath, "Output/Simulation: Domain = 32, res = 128, save_freq = 200, IC = GaussianBlob, Ensemble = true"))
file1 = joinpath(pwd(), "SimulationData.jld2")
file2 = joinpath(pwd(), "SimulationData_1.jld2")
