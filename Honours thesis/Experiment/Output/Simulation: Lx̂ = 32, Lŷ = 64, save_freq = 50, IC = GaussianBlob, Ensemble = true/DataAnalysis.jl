...
first_mom_lower = plot(t, first_moms[:, 2, 1], 
                        ...
                        legend = :bottomright)
for i ∈ 2:length(data)
    plot!(first_mom_upper, t, first_moms[:, 1, i], label = "Ensemble member "*string(i))
    plot!(first_mom_lower, t, first_moms[:, 2, i], label = "Ensemble member "*string(i))
end
...
savefig(fullplot, "Gaussblob_3264dom_dt4500.png")
##
Δt = t[25] - t[1]
