#Point tracer release. Randomly choose a single grid cell to contain tracer conetration.
#Might be able to get a useful plot to explain the different Garrett areas from this.

#Passive tracer advection using a two layer QG flow (from the geophysical flows package).

using .TracerAdvDiff_QG

using GeophysicalFlows.MultiLayerQG, Distributions
using Random: seed!
